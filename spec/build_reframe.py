...
SRC = BASE / "CDK-OUTREACH-REFRAME.md"
OUT = BASE / "EVEglyphDesign_CDK_Outreach_Reframe.pdf"
...
body_md = re.sub(r"^# The CDK Outreach, Reframed.*?\n---\n", "", raw, flags=re.S)
...
@page {
  ...
  @bottom-left {
    content: "EVEglyphDesign · EgD-HAW-CDK-OUT-002 r1";
...
<section class="cover">
  <div class="rule"></div>
  <h1>The CDK Outreach,<br>Reframed</h1>
