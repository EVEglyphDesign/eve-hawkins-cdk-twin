...
SRC = BASE / "PACCAR-FEEDBACK-STANDARD.md"
OUT = BASE / "EVEglyphDesign_PACCAR_Feedback_Standard.pdf"
...
body_md = re.sub(r"^# The PACCAR Feedback Standard.*?\n---\n", "", raw, flags=re.S)
...
@page {
  ...
  @bottom-left {
    content: "EVEglyphDesign · EgD-HAW-CDK-PLUG-001 r1";
...
<section class="cover">
  <div class="rule"></div>
  <h1>The PACCAR<br>Feedback Standard</h1>
