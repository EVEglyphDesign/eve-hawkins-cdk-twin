...
SRC = BASE / "ROOFTOP-ACCOUNT-RECONCILIATION.md"
OUT = BASE / "EVEglyphDesign_Rooftop_Account_Reconciliation.pdf"
...
body_md = re.sub(r"^# Rooftops and CDK Accounts.*?\n---\n", "", raw, flags=re.S)
...
@page {
  ...
  @bottom-left {
    content: "EVEglyphDesign · EgD-HAW-CDK-REC-004 r1";
...
<section class="cover">
  <div class="rule"></div>
  <h1>Rooftops and<br>CDK Accounts</h1>
  <h2>Eight locations, eight accounts, and why<br>they do not map one to one</h2>
  <dl>
    <dt>Document</dt><dd>EgD-HAW-CDK-REC-004 · revision 1</dd>
    <dt>Client context</dt><dd>Peterbilt Atlantic — eight locations, five provinces — eight CDK accounts on invoice 10002236</dd>
    <dt>Companion to</dt><dd>Corrects EgD-HAW-CDK-PLUG-001, -OUT-002 and -OUT-003</dd>
    <dt>Prepared by</dt><dd>EVEglyph Design</dd>
    <dt>Status</dt><dd>Reconciliation and correction notice. Supersedes the nine-rooftop figure used in EgD-HAW-CDK-PLUG-001, -OUT-002 and -OUT-003.</dd>
  </dl>
  <div class="foot">
